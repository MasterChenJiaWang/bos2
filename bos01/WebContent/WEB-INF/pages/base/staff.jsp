...
<script type="text/javascript">
	...
	function doDblClickRow(rowIndex, rowData){//{id:xxx,name:xx,}
		...
		//回显数据
		$("#editStaffForm").form("load",rowData);//需要和表单中的name属性对应，id,name,
	}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 查询分区 -->
	<div class="easyui-window" title="查询取派员窗口" id="searchStaffWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchStaffForm"  method="post" action="">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
					...
					<tr>
						<td>是否有PDA</td>
						<td>
							<input type="radio" name="staff.haspda"  value="'1'"/>有
							<input type="radio" name="staff.haspda"  value="'0'"/>无
						</td>
					</tr>
					<tr>
						<td>取派标准</td>
						<td><input type="text" name="staff.standard"/></td>
					</tr>
					<tr>
						<td>单位</td>
