...
<script type="text/javascript">
	...
	function doDelete(){
		...
		if(rows.length == 0){
			...
			var ids = array.join(",");
			//发送请求，传递ids参数
			window.location.href = '${pageContext.request.contextPath}/subareaAction_delete.action?ids='+ids;
		}
	}
	...
	function doDblClickRow(rowIndex, rowData){
		...
		//回显数据
		$("#editSubareaForm").form("load",rowData);//需要和表单中的name属性对应，id,name,
	}
	
	
	//工具方法，可以将指定的表单序列化为Json对象
	$(function(){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 修改窗口 -->
	<div class="easyui-window" title="分区修改" id="editSubareaWindow" collapsible="false" 
